// plugins/vv2.js
// SARWAR MD — View Once Retriever (Without Prefix + Emojis)

const { cmd } = require("../command");

// ─────────────────────────────────────────────────────────────
//  ALL EMOJIS FOR TRIGGERS
// ─────────────────────────────────────────────────────────────
const EMOJIS = [
    // Smileys
    "😀", "😃", "😄", "😁", "😆", "😅", "😂", "🤣", "😊", "😇", "🙂", "🙃", "😉", "😌", "😍", "🥰",
...
cmd({
    ...
    try {
        ...
        // Check if message is an emoji or command
...
📌 *Reply to a view-once message and type any emoji or:*
• vv2
• wah
• nice
• ok
