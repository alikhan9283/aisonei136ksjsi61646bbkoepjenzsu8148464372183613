...
// This command uses a second, independent code path from tiktoksearch.js
// so the two commands don't share a single point of failure.
// It hits Tikwm's general-purpose "feed/search" mirror endpoint with a
// different parameter set (region + sort_type) which some Tikwm mirrors
// expose separately from the primary search endpoint.
